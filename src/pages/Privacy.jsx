...
const Privacy = () => (
    <>
        <HeaderContainer />
        <Wrapper>
            <Title>Privacy Policy for Dropform</Title>

            <Text>At Dropform, accessible from www.dropform.co, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Dropform and how we use it.</Text>
            ...
            <Text>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Dropform. This policy is not applicable to any information collected offline or via channels other than this website. Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.info">Free Privacy Policy Generator</a>.</Text>
            ...
            <ul style={{ padding: '0px 30px' }}>
                <li style={{ marginBottom: '10px' }}>Provide, operate, and maintain our website</li>
                <li style={{ marginBottom: '10px' }}>Improve, personalize, and expand our website</li>
                <li style={{ marginBottom: '10px' }}>Understand and analyze how you use our website</li>
                <li style={{ marginBottom: '10px' }}>Develop new products, services, features, and functionality</li>
                <li style={{ marginBottom: '10px' }}>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes</li>
                <li style={{ marginBottom: '10px' }}>Send you emails</li>
                <li style={{ marginBottom: '10px' }}>Find and prevent fraud</li>
            </ul>

            <SubTitle>Log Files</SubTitle>

            <Text>Dropform follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</Text>
            ...
            <Text>You may consult this list to find the Privacy Policy for each of the advertising partners of Dropform.</Text>

            <Text>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Dropform, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.</Text>

            <Text>Note that Dropform has no access to or control over these cookies that are used by third-party advertisers.</Text>

            <SubTitle>Third Party Privacy Policies</SubTitle>

            <Text>Dropform's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Text>
            ...
            <SubTitle>CCPA Privacy Rights (Do Not Sell My Personal Information)</SubTitle>
